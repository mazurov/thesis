...
\bibliographystyle{bib/LHCb}%        Tell BibTeX which .bst file to use (may need full path)
\bibliography{bib/main}
% \bibliography{bib/references}%        The .bib file which contains all your exported BibTeX information
\end{document}
