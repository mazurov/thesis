...
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & 23.0 $\pm$ 1.6\stat${}^{+1.1}_{-1.3}\syst^{+1.0}_{-0.5}\systpol \%$ & 22.9 $\pm$ 1.0\stat${}^{+1.1}_{-1.4}\syst^{+1.0}_{-0.5}\systpol \%$\\
...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & 24.7 $\pm$ 1.7\stat${}^{+1.3}_{-1.6}\syst^{+1.3}_{-0.8}\systpol \%$ & 25.2 $\pm$ 1.2\stat${}^{+1.2}_{-1.4}\syst^{+1.4}_{-0.8}\systpol \%$\\
...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & 26.4 $\pm$ 1.4\stat${}^{+1.1}_{-1.4}\syst^{+0.9}_{-0.7}\systpol \%$ & 29.3 $\pm$ 0.9\stat${}^{+1.3}_{-1.5}\syst^{+1.0}_{-0.8}\systpol \%$\\
...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & 33.2 $\pm$ 2.5\stat${}^{+1.2}_{-1.3}\syst^{+0.6}_{-0.7}\systpol \%$ & 31.0 $\pm$ 1.6\stat${}^{+1.1}_{-1.3}\syst^{+0.6}_{-0.7}\systpol \%$\\

\rule{0pt}{4ex}$\chi_b(2P) \to \Y1S \gamma$ & 6.6 $\pm$ 1.2\stat${}^{+0.3}_{-0.3}\syst^{+0.4}_{-0.3}\systpol \%$ & 4.9 $\pm$ 0.8\stat${}^{+0.2}_{-0.2}\syst^{+0.3}_{-0.2}\systpol \%$\\

\rule{0pt}{4ex}$\chi_b(3P) \to \Y1S \gamma$ & 2.0 $\pm$ 0.9\stat${}^{+0.4}_{-0.3}\syst^{+0.2}_{-0.1}\systpol \%$ & 1.2 $\pm$ 0.6\stat${}^{+0.1}_{-0.1}\syst^{+0.1}_{-0.1}\systpol \%$\\
\bottomrule
\end{tabular}
} % scalebox
...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(1P) \to \Y1S \gamma$ & 34.6 $\pm$ 2.9\stat${}^{+1.3}_{-1.3}\syst^{+1.0}_{-1.3}\systpol \%$ & 33.5 $\pm$ 2.3\stat${}^{+1.4}_{-1.9}\syst^{+1.0}_{-1.3}\systpol \%$\\
...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & 31 $\pm$ 5\stat${}^{+1.1}_{-2.0}\syst^{+2.9}_{-2.2}\systpol \%$ & 34 $\pm$ 4\stat${}^{+1.1}_{-1.5}\syst^{+3.2}_{-2.4}\systpol \%$\\
...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & 34 $\pm$ 11\stat${}^{+1.3}_{-2.6}\syst^{+1.3}_{-2.0}\systpol \%$ & 31 $\pm$ 7\stat${}^{+1.2}_{-2.1}\syst^{+1.2}_{-1.8}\systpol \%$\\
...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(2P) \to \Y2S \gamma$ & 26 $\pm$ 7\stat${}^{+0.8}_{-1.4}\syst^{+1.2}_{-1.1}\systpol \%$ & 31 $\pm$ 4\stat${}^{+1.0}_{-1.4}\syst^{+1.4}_{-1.4}\systpol \%$\\
...
\cmidrule(r){2-3}
 & \multicolumn{1}{c}{\sqs = 7\tev} & \multicolumn{1}{c}{\sqs = 8\tev}\\
\midrule
$\chi_b(3P) \to \Y3S \gamma$ & 42 $\pm$ 12\stat${}^{+8.9}_{-11.6}\syst^{+2.9}_{-2.9}\systpol \%$ & 41 $\pm$ 8\stat${}^{+1.3}_{-8.6}\syst^{+2.8}_{-2.9}\systpol \%$\\
\bottomrule
\end{tabular}
} % scalebox
